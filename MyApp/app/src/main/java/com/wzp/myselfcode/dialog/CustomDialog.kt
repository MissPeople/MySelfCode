...
class CustomDialog(context: Context, themeResId: Int) : Dialog(context, themeResId) {
    class Builder(private val context: Context) {
        ...
        fun create(): CustomDialog {
            val dialog = CustomDialog(context, R.style.custom_dialog)

            val inflater =
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            val dialogLayoutView = inflater.inflate(R.layout.dialog_my_custom_dialog_layout, null)
            ...
            if (!TextUtils.isEmpty(negativeButtonContent)) {
                ...
                if (negativeButtonListener != null) {
                    (dialogLayoutView.findViewById<View>(R.id.tv_dialog_neg) as TextView)
